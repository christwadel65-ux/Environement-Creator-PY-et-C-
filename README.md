# 💻 Environement-Creator-PY-et-C-

![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?logo=typescript&logoColor=white)
![Node.js](https://img.shields.io/badge/Node.js-339933?logo=node.js&logoColor=white)
![npm](https://img.shields.io/npm/v/Environement-Creator-PY-et-C-)
![License](https://img.shields.io/github/license/christwadel65-ux/Environement-Creator-PY-et-C-)
![Stars](https://img.shields.io/github/stars/christwadel65-ux/Environement-Creator-PY-et-C-?style=social)
...
```bash
npm install -g Environement-Creator-PY-et-C-
```

### Via npx (sans installation)

```bash
npx Environement-Creator-PY-et-C- [command]
```
...
```typescript
import { Generator } from 'Environement-Creator-PY-et-C-';
...
- [Signaler un bug](https://github.com/christwadel65-ux/Environement-Creator-PY-et-C-/issues)
